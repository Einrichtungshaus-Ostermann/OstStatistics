 ...
 *
 * Collects statistics and records every click for every user with date, ip, session id,
...
namespace OstStatistics;

use Shopware\Components\Plugin;
use Shopware\Components\Plugin\Context;
use Symfony\Component\DependencyInjection\ContainerBuilder;

class OstStatistics extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_statistics.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_statistics.view_dir', $this->getPath() . '/Resources/views/');
